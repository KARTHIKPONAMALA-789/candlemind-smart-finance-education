            ...
            <AnimatePresence initial={false}>
              {messages.map((m, i) => (
                ...
                >
                  ...
                  >
                    {m.role === "assistant" ? (
                      <div className="prose prose-sm prose-invert max-w-none prose-headings:mt-3 prose-headings:mb-1 prose-headings:text-foreground prose-p:my-1.5 prose-ul:my-1.5 prose-li:my-0.5 prose-strong:text-foreground prose-em:text-muted-foreground">
