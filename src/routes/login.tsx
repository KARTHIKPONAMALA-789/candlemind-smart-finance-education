      ...
      <div className="flex items-center justify-center p-6">
        ...
        >
          ...
          <div className="mt-6 grid grid-cols-2 gap-3">
            <button className="glass rounded-xl py-2.5 text-sm hover:bg-foreground/10 transition flex items-center justify-center gap-2">
          ...
          <form className="space-y-3" onSubmit={(e) => e.preventDefault()}>
            ...
            <button
              type="submit"
              className="w-full py-2.5 rounded-xl bg-[image:var(--gradient-primary)] text-primary-foreground font-medium hover:shadow-[var(--shadow-glow)] transition"
            >
